  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of travel with Car Sharing Application - a seamless, eco-friendly and cost-effective way to get around."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of travel with Car Sharing Application - a seamless, eco-friendly and cost-effective way to get around.`}
            </Text>
            <Box
